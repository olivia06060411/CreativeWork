(function(){ 
  ...
  // 修改
  $('#CreativeWork').addEventListener('change', function() { 
    ...
    retrieve($('#CreativeWork').value, '_', '1b', 'query');  
    retrieve($('#CreativeWork').value, relation_list, '2a', 'query');  // 2 query parameters
  });
  ...
  $('#checkbox_submit').addEventListener('click', function() { 
    ...
    // Display the person node first, in case the next query has null result
    retrieve($('#CreativeWork').value, '_', '1b', 'query');  
    retrieve($('#CreativeWork').value, relation_list, '2a', 'query');  // 2 query parameters, query2a processes parameter2 as a list
  });


  // Social network buttons
  
$('#achievement_relation').addEventListener('click', function() {
  retrieve('Achievement Network', ['achievement'], 'relationList', 'query')
});


$('#creator_of_relation').addEventListener('click', function() {
  retrieve('Creator Network', ['creator_of'], 'relationList', 'query')
});

$('#movie_relation').addEventListener('click', function() {
  retrieve('Movie Network', ['movie'], 'relationList', 'query')
});

$('#music_relation').addEventListener('click', function() {
  retrieve('Music Network', ['music'], 'relationList', 'query')
});

$('#performance_relation').addEventListener('click', function() {
  retrieve('Performance Network', ['performance'], 'relationList', 'query')
});
  ...
  async function retrieve(parameter1, parameter2, queryID, elementID_query) {
    ...
    API_domain = 'https://km6321-jyh.as.r.appspot.com'
